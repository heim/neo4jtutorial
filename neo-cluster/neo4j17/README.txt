...
Welcome to Neo4j release 2.0.1, a high-performance graph database.
...
For full instructions, see http://docs.neo4j.org/chunked/2.0.1/deployment.html
...
* Getting Started: http://docs.neo4j.org/chunked/2.0.1/introduction.html
* The Neo4j Manual (online): http://docs.neo4j.org/chunked/2.0.1/
